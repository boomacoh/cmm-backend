...
@Slf4j
@Component
public class FindManagedClubsByUserIdHandler {
    private final ClubRepository clubRepository;
    private final ClubDataMapper clubDataMapper;
    private final DeviceRepository deviceRepository;
    private final UserRepository userRepository;
    private final AuthenticationService authenticationService;
    public FindManagedClubsByUserIdHandler(
    ...
    public ClubListResponse findClubs(String token) {
        ...
        return new ClubListResponse( clubRepository.findManagedByUser(user.getUserId().getValue()).stream().map(e->{
