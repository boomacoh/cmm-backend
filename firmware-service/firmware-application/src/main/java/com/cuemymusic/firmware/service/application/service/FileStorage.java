package com.cuemymusic.firmware.service.application.service;
...
public class FileStorage {
    ...
    private final Path root = Paths.get("firmware");
    ...
    public String save(MultipartFile file) {
        ...
        try {
            ...
            Path filename = this.root.resolve(UUID.randomUUID()+"."+extension);
